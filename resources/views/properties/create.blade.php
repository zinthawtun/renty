                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('properties.store')}}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <textarea id="title" type="text" class="form-control{{ $errors->has('address') ? ' is-invalid' : '' }}" name="address" value="{{ old('address') }}" required autofocus></textarea>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-3">
                                    <input id="title" type="text" class="form-control{{ $errors->has('post_code') ? ' is-invalid' : '' }}" name="post_code" value="{{ old('post_code') }}" required autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="content" type="text" class="form-control{{ $errors->has('tenant_no') ? ' is-invalid' : '' }}" name="tenant_no" value="{{ old('tenant_no') }}" required autofocus>
